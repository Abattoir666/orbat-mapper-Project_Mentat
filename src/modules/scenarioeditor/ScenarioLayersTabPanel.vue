<script setup lang="ts">
    ...
    const mapLayerButtonItems: ButtonGroupItem[] = [
        ...
        {
            label: "Add NASA FIRMS layer",
            onClick: () => addNewMapLayer("FIRMSLayer"),
        },
    ];
    ...
    const mapLayersMenuItems: MenuItemData[] = [
        ...
        { label: "Add NASA FIRMS layer", action: () => addNewMapLayer("FIRMSLayer") },
    ];
...
<template>
    <div>
        <ChevronPanel label="Map layers"
                      class="mb-4"
                      header-class="ml-4"
                      v-model:open="uiStore.mapLayersPanelOpen">
            <template #right>
                <div class="flex items-center">
                    <DotsMenu class="opacity-0 group-focus-within:opacity-100 group-hover:opacity-100"
                              :items="mapLayersMenuItems" />
                </div>
            </template>
            <ul class="-mt-6">
                <li v-for="layer in mapLayers"
          ...
          ">
                    <button class="flex flex-auto items-center py-2.5 sm:py-2">
                        ...
                        <span class="ml-2 text-left text-sm group-hover:text-gray-900"
                              :class="{
                ...
                'opacity-50': layer.isHidden,
                    ...
                    <div class="relative flex items-center">
                        <span v-if="layer._isTemporary"
                              class="badge"
                              title="Temporary layer. Not saved">TEMP</span>
                        <button type="button"
                        ...
                        <DotsMenu :items="mapLayerMenuItems"
        ...
        <ScenarioFeatureLayer v-for="{ layer, features } in scenarioLayersFeatures"
                              :key="layer.id"
                              :features="features"
                              :layer="layer"
