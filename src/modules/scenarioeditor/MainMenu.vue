    ...
    <DropdownMenu>
        <DropdownMenuTrigger as="div" class="bg-opacity-50 relative bg-gray-900">
            <button class="group flex items-center">
                ...
                <span class="ml-2 hidden font-medium tracking-tight sm:block">ORBAT-Mapper — PROJECT Mentat</span>
        ...
        <DropdownMenuContent class="" align="start" :side-offset="10">
            ...
            <DropdownMenuSub>
                ...
                <DropdownMenuSubContent>
                    ...
                    <DropdownMenuCheckboxItem v-model="uiSettings.showOrbatBreadcrumbs"
                                              @select.prevent>Unit breadcrumbs</DropdownMenuCheckboxItem>
                    <DropdownMenuSeparator />
                    ...
                    <DropdownMenuSub>
                        <DropdownMenuSubTrigger inset><span class="pr-4">Measurement units</span></DropdownMenuSubTrigger>
                        <DropdownMenuSubContent>
